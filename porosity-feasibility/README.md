...
├── README.md                              this file
├── REPORT.md                               short customer-facing summary
...
- `thickness_effect.html` — supplementary figure: effect of adding thickness as a
  predictor, referenced in `REPORT.md` but not generated by either notebook above or part
  of the primary pipeline's stages.
